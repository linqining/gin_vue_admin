...
if (!address._value||!isConnected){
  ...
  router.push({ path: '/solid_career/login'})
}else{
...
<style >
@import "@/style/solid/home/style.css";
</style>
  ...
  <div class="job">
    <div class="header">
      ...
      <div class="header-menu">
        <router-link to="/solid_career/home" :class="{active:showTag==1}" @click="showHomeTag">首页</router-link>
        <router-link to="/solid_career/company"  :class="{active:showTag==2}" @click="showCompanyTag">公司</router-link>
        <router-link to="/solid_career/profile" :class="{active:showTag==3}" @click="showProfileTag">我的</router-link>
      </div>
