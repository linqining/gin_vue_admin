  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
          ...
          <el-table-column align="left" label="薪资下限" prop="salarmBottom" width="120" />
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="职位描述:"  prop="description" >
              <el-input v-model.number="formData.description" :clearable="true" placeholder="请输入职位描述" />
            </el-form-item>
            <el-form-item label="薪资下限:"  prop="salarmBottom" >
              <el-input v-model.number="formData.salarmBottom" :clearable="true" placeholder="请输入薪资下限" />
            </el-form-item>
